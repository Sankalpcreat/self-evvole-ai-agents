...
Do not repeat a question if the borrower has already answered it. If the borrower refuses to answer, record the field as undisclosed and continue. Explicitly record the borrower's stated preferred resolution path in viable_path even if only high-level.
