...
![Baseline composite by persona](report_assets/riverline_baseline_composite.png)
...
![Baseline metric matrix](report_assets/riverline_metric_matrix.png)
...
![Prompt evolution](report_assets/riverline_prompt_evolution.png)

## Meta-Evaluation

The latest meta-evaluation artifact is `data/meta_evaluation/meta_eval_20260525T040652Z.json`.

![Meta-evaluation findings](report_assets/riverline_meta_eval_findings.png)
...
![Cost breakdown](report_assets/riverline_cost_breakdown.png)
